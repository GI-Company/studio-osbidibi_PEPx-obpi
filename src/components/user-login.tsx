...
export default function UserLogin() {
  const { login, resetToModeSelection, switchToOnboarding } = useAuth();
      ...
      <Card className="w-full max-w-md glassmorphic">
        ...
        <CardContent>
         ...
         <CardFooter className="flex-col items-center space-y-3 pt-6">
           <Button variant="link" size="sm" onClick={switchToOnboarding} className="text-primary radiant-text button-3d-interactive" disabled={isLoading}>
