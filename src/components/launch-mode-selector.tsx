    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-background via-secondary/10 to-background p-4">
      <Card className="w-full max-w-md glassmorphic">
        <CardHeader className="items-center text-center">
          ...
          <CardDescription className="radiant-text">Select Operating Mode</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <Button 
            variant="outline" 
            className="w-full h-auto py-4 text-left flex items-start space-x-3 hover:bg-primary/10 group button-3d-interactive"
            onClick={() => selectMode('persistent')}
          >
            <Database className="w-8 h-8 mt-1 text-primary group-hover:text-accent transition-colors" />
            <div>
              <p className="font-semibold text-base text-foreground group-hover:text-accent transition-colors radiant-text">Persistent Mode</p>
              <p className="text-sm text-muted-foreground radiant-text">
          ...
          >
            ...
            <div>
              <p className="font-semibold text-base text-foreground group-hover:text-accent transition-colors radiant-text">Ghost Mode (No Fingerprint)</p>
              <p className="text-sm text-muted-foreground radiant-text">
        ...
        <CardFooter className="text-xs text-muted-foreground justify-center radiant-text">
          <Server className="w-3 h-3 mr-1.5"/>
          BinaryBlocksphere Instance v0.5.1
        </CardFooter>
      </Card>
    </div>
  );
